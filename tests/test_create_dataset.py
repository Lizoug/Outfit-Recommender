...
def test_create_dataset():
    ...
    test_df = pd.DataFrame({'id': [1, 2, 3, 4], 
                            'articleType': ['Shirts', 'Jeans', 'Tshirts', 'Tops'], 
                            'baseColour': ['Navy Blue', 'Silver', 'Black', 'Green'], 
                            'year': [2010, 2011, 2012, 2013], 
                            'usage': ['Casual', 'Formal', 'Party', 'Sports'],
                            'productDisplayName': ['Test1', 'Test2', 'Test3', 'Test4'], 
                            'masterCategory': ['Clothing', 'Clothing', 'Clothing', 'Clothing'],
                            'subCategory': ['Topwear', 'Bottomwear', 'Topwear', 'Topwear']})
